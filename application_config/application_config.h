...
#define APPLICATION_FW_VERSION "SENSIFW 3.17.0"
...
// Sample rate is in Hz. This configures only the sensor, not transmission rate of data.
  ...
  #define APPLICATION_ENVIRONMENTAL_SAMPLERATE SENSI_DRIVER_SENSOR_CFG_MIN

  // Resolution and scale cannot be adjusted on BME280
  #define APPLICATION_ENVIRONMENTAL_RESOLUTION SENSI_DRIVER_SENSOR_CFG_DEFAULT
  #define APPLICATION_ENVIRONMENTAL_SCALE      SENSI_DRIVER_SENSOR_CFG_DEFAULT

  // Valid values for BME280 are: (SENSI_DRIVER_SENSOR_DSP_)LAST, IIR, OS
  // IIR slows step response but lowers noise
  // OS increases power consumption but lowers noise.
  // See https://blog.SENSI.com/humidity-sensor-673c5b7636fc and https://blog.SENSI.com/dsp-compromises-3f264a6b6344
  #define APPLICATION_ENVIRONMENTAL_DSPFUNC    SENSI_DRIVER_SENSOR_DSP_IIR

  // No effect on _LAST, use 1. On _OS and _IIR valid values are 2, 4, 8 and 16.
  #define APPLICATION_ENVIRONMENTAL_DSPPARAM   SENSI_DRIVER_SENSOR_CFG_MAX

  // (SENSI_DRIVER_SENSOR_CFG_)SLEEP, SINGLE or CONTINUOUS
  #define APPLICATION_ENVIRONMENTAL_MODE       SENSI_DRIVER_SENSOR_CFG_CONTINUOUS
#endif


// Allow BME280 support compilation
#define SENSI_INTERFACE_ENVIRONMENTAL_BME280_ENABLED 1
 ...
 **/
  ...
  #define APPLICATION_ACCELEROMETER_SCALE   SENSI_DRIVER_SENSOR_CFG_MIN

  // LAST or HIGH_PASS
  #define APPLICATION_ACCELEROMETER_DSPFUNC SENSI_DRIVER_SENSOR_DSP_LAST
  #define APPLICATION_ACCELEROMETER_DSPPARAM 1

  // SLEEP or CONTINUOUS
  #define APPLICATION_ACCELEROMETER_MODE SENSI_DRIVER_SENSOR_CFG_CONTINUOUS
...
#define SENSI_INTERFACE_ACCELERATION_LIS2DH12_ENABLED 0

/**
 *  ADC configuration
 */
#define APPLICATION_ADC_SAMPLERATE         SENSI_DRIVER_SENSOR_CFG_MIN // Valid for continuous mode
#define APPLICATION_ADC_RESOLUTION         10
#define APPLICATION_ADC_SCALE              SENSI_DRIVER_SENSOR_CFG_DEFAULT
#define APPLICATION_ADC_DSPFUNC            SENSI_DRIVER_SENSOR_DSP_LAST
#define APPLICATION_ADC_DSPPARAM           1
#define APPLICATION_ADC_MODE               SENSI_DRIVER_SENSOR_CFG_SINGLE // Note: call to task_adc_sample will leave the ADC in single-shot mode. Use data get only in continuous mode
...
// Avoid "even" values such as 100 or 1000 to eventually drift apart from the devices transmitting at same interval
  ...
  #define APPLICATION_ADVERTISING_POWER                 SENSI_BOARD_TX_POWER_MAX
 ...
 * NFC configuration
 */
// Longest text in a text field, i.e. "FW: SENSI.firmware.c 3.10.0
...
// SENSI_INTERFACE_LOG_ ERROR, WARNING, INFO, DEBUG
#define APPLICATION_LOG_LEVEL                       SENSI_INTERFACE_LOG_INFO
